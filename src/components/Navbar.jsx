...
export default function Navbar() {
  return (
    <header className="xl:hidden sticky top-0 z-30 flex items-center justify-between px-4 py-3 bg-[var(--color-ink)]/95 backdrop-blur border-b border-[var(--color-ink-border)]">
      <Logo />
